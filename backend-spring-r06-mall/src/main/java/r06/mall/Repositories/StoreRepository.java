...
public interface StoreRepository extends JpaRepository<CuaHang, String> {
        @Query(value = "select SanPham.CuaHangId, CuaHang.TenCuaHang, SUM(SanPham.DonGia * DonHangSanPham.SoLuong) as DoanhThu, "
                        + "SUM(DonHangSanPham.SoLuong) as SoLuong, Year(DonHang.ThoiGian) as Nam, Month(DonHang.ThoiGian) as Thang , CuaHang.HoaHong as HoaHong "
                        ...
                        + "group by SanPham.CuaHangId, CuaHang.TenCuaHang, DonHang.ThoiGian, HoaHong order by DonHang.ThoiGian desc", nativeQuery = true)
        ...
        @Query(value = "select SanPham.CuaHangId, CuaHang.TenCuaHang, SUM(SanPham.DonGia * DonHangSanPham.SoLuong) as DoanhThu, "
                        ...
                        + "group by SanPham.CuaHangId, CuaHang.TenCuaHang, DonHang.ThoiGian, HoaHong", nativeQuery = true)
